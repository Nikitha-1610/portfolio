...
<h1 className="text-neutral-400 font-segoe text-[24px] sm:text-[28px] md:text-[36px] lg:text-[40px] font-normal text-center px-6 sm:px-8 md:px-10 py-6 sm:py-8 md:py-10">
